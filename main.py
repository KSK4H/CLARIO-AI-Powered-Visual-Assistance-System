...
from object_models import color_detection_camera
#from object_models.color_detection_camera import perform_color_detection
...
@app.route('/color-detect/start', methods=['POST'])
def color_detect_start():
    result, audio = color_detection_camera.perform_color_detection()
    return render_template(
        'color-detection.html',
        result=result,
        audio=audio
    )
